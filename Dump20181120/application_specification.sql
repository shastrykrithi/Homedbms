...
CREATE TABLE `specification` (
  ...
  PRIMARY KEY (`id`,`cutid`),
  UNIQUE KEY `specify_UNIQUE` (`specify`),
  KEY `cutid_idx` (`cutid`),
  CONSTRAINT `cutid` FOREIGN KEY (`cutid`) REFERENCES `cutoff` (`cutid`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
-- Dump completed on 2018-11-20 11:27:07
