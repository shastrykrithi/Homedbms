...
CREATE TABLE `cutoff` (
  ...
  `comedk` int(11) DEFAULT NULL,
  `jee` int(11) DEFAULT NULL,
  PRIMARY KEY (`cutid`,`depid`),
  KEY `depid_idx` (`depid`),
  CONSTRAINT `depid` FOREIGN KEY (`depid`) REFERENCES `requirement` (`depid`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
-- Dump completed on 2018-11-20 11:27:03
