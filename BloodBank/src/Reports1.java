...
/**
 * Servlet implementation class Reports1
 */
@WebServlet("/Reports1")
public class Reports1 extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			rs=st.executeQuery("select * from reports where Date_out between '"+d1+"' and '"+d2+"'");
			...
			out.println("<form action=\"rindex.html\">"
					+ "<center><br><input type=\"submit\" name=\"id\" value=\"Check for other dates\">"
					+ "</center></form>");
